...
public class DummySocialNetwork {
    ...
    public static void main(String[] args) {
        ...
        MongoDBManager mongoDBManager = new MongoDBManager("mongodb://98.84.89.194:27017", "dav_gim_rod", "prueba");
        int opcion;
        do {
            opcion = menu();
            switch (opcion) {
    ...
    private static int menu() {
        ...
        System.out.println("1. Crear o entrar en mi perfil");
    ...
    private static void newProfile(MongoDBManager mongoDBManager) {
        System.out.println("Crear o entrar en mi perfil");
        System.out.print("Introduce tu nombre para verificar si existe:");
        String name = scanner.nextLine();

        // Verifica si el perfil ya existe
        if (mongoDBManager.loadProfile(name)) {
            System.out.println("Bienvenido de nuevo, " + name + ". Tu perfil ha sido cargado.");
        } else {
            System.out.println("Tu usuario no existe, procedemos a crearlo...");
